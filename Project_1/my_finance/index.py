...
app = FastAPI(
    title="Financial-Data-APIs",  # TODO for homework, name your application
    # <major_version>.<minor_version>.<patch_version>
    version="1.2.0",  # increase version after finishing homework
    description="A collection of python modules to get stock data from Yahoo Finance",  # TODO add a description
)
